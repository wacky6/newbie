...
let app = koa()
    ...
    .route( './route/redirect', '//www.', '//', 'Canonicalization' )
    .route( './route/redirect', '//std-aries.xyz/', '//wacky.one/', 'Change-Domain-Name' )
    .route( './route/redirect', /\/(About|Blog)\//, (path)=>path.toLowerCase(), 'Canonicalization' )
